...
const page = () => {
  ...
  return (
    <div>
      ...
      <h3 className='title'>
        <strong>Title:&nbsp;&nbsp;</strong>
        {artworks[2].title_eng}
      </h3>
      <p className='artist-bio'>
        <strong>Statement:&nbsp;&nbsp;</strong>
        {artworks[2].statement}
      </p>
      <div className='mt-10 mr-auto ml-auto mb-10 w-1/4'>
        <Image image={{ src: artworks[2].src, title: artworks[2].title_eng }} />
      </div>
      <h3 className='title'>
        <strong>Title:&nbsp;&nbsp;</strong>
        {artworks[3].title_eng}
      </h3>
      <p className='artist-bio'>
        <strong>Statement:&nbsp;&nbsp;</strong>
        {artworks[3].statement}
      </p>
      <div className='mt-10 mr-auto ml-auto mb-10 w-1/4'>
        <Image image={{ src: artworks[3].src, title: artworks[3].title_eng }} />
      </div>
      <h3 className='title'>
        <strong>Title:&nbsp;&nbsp;</strong>
